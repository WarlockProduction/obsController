<script>
  ...
  async function connect() {
    ...
    const fAddress = `wss://${new URL(document.location.href).hostname}/api/?obs=${address}`;
    await disconnect();
    try {
...
<footer class="footer">
  <div class="content has-text-centered">
    <p>
      ...
      &mdash; Refork version by
      <a href="https://www.instagram.com/warlock_production"
        >Warlock Production</a
      >
      &
      <a href="https://insta.gwenitora.com/">REYLANS Gwendal (Gwenitora)</a>
      &mdash; see
